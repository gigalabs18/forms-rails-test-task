...
Rails.application.configure do
  ...
  # Running on bare IP without HTTPS: do not assume or force SSL.
  config.assume_ssl = false

  # Force-SSL disabled for IP-only HTTP access.
  ...
  config.action_mailer.default_url_options = { host: "165.22.219.99", protocol: "http" }
  ...
  # Enable DNS rebinding protection and allow your tunneling domain.
  # Add patterns rather than single hosts so rotating ngrok subdomains work.
  config.hosts = []
