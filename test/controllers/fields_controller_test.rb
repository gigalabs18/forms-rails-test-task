...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference("Field.count") do
      post fields_url, params: { field: { field_type: @field.field_type, form_id: @field.form_id, label: @field.label, position: @field.position } }
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { field_type: @field.field_type, form_id: @field.form_id, label: @field.label, position: @field.position } }
