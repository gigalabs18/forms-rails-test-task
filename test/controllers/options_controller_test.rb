...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference("Option.count") do
      post options_url, params: { option: { field_id: @option.field_id, label: @option.label, position: @option.position, value: @option.value } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { field_id: @option.field_id, label: @option.label, position: @option.position, value: @option.value } }
